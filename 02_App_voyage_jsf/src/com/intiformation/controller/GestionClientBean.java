...
public class GestionClientBean implements Serializable {
	 ...
	 * la meth est utilisée par le composant : 
	 * pour afficher la liste des clients dans la bdd
	 * @return
	 */
	...
	/**
	 * meth permet de supprimer un livre dans la bdd .
	 * meth invoquée au click sur le lien 'supprimer' de la page 'accueil.xhtml'.
	 * au click, l'évenement 'javax.faces.event.ActionEvent' se déclenche.
	 * l'évenement encapsule ttes les infos concernant le composant.
		...
		if (clientDAO.delete(clientId)) {
			...
			contextJSF.addMessage(null, 
								new FacesMessage(FacesMessage.SEVERITY_FATAL, 
												" la suppression du client à échouée", 
	...
	/**
	 * meth qui permet de récup le client dans la bdd avant sa modification.
	 * meth invoquée au click sur le lien 'modification'
	 * au click, l'évenement 'javax.faces.event.ActionEvent' se déclenche.
	 * l'évenement encapsule ttes les infos concernant le composant.
	 */
	...
	/**
	 * meth permet de modifier un client dans la bdd.
	 * meth invoquée au click sur le lien 'modifier'
	 * au click, l'évenement 'javax.faces.event.ActionEvent' se déclenche.
	 * l'évenement encapsule ttes les infos concernant le composant.
	...
	public void modifierClient(ActionEvent event) {
		...
		if (clientDAO.update(client)) {
			...
			// msg vers la vue 
			FacesMessage messageNotOk = new FacesMessage(FacesMessage.SEVERITY_INFO, 
	...
	/**
	 * meth permet d'initialiser un nouveau objet client vide.
	 * meth invoquée au click sur le lien 'ajouter' ou 's'inscrire'
	 * au click, l'évenement 'javax.faces.event.ActionEvent' se déclenche.
	 * l'évenement encapsule ttes les infos concernant le composant.
	 */
	public void initialiserClient(ActionEvent event) {
		...
		// cet objet va receptionner les infos du client envoyées à partir du formulaire d'ajout
		setClient(clientAdd);
	...
	/**
	 * meth permet d'ajouter un nouveau client dans la bdd.
	 * meth invoquée au click sur le lien 'ajouter' ou 's'inscrire'
	 */
	public void ajouterClient() {
		...
		if (verifAjout) {
			...
			contextJSF.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Ajout du client", " - L'ajout est réussi "));	
			...
			// envoi d'un msg vers la vue
			FacesMessage messageAddNotOk = new FacesMessage(FacesMessage.SEVERITY_FATAL, "Ajout du client", " - L'ajout à échoué !");
